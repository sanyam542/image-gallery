...
export default function Popup(props) {
  return props ? (
    <div
      className="  fixed md:top-[15%] md:left-[10%] top-[15%] left-[2.5%]  md:w-4/5 md:h-4/5
      w-[95%] h-[75%] bg-white ease-in flex justify-between  md:justify-start items-center flex-col dark:bg-neutral-600  rounded-xl transition-all  duration-300 z-10"
    >
      <img
      ...
      />
      <button
        className=" md:left-[88%] md:w-9  text-black bg-neutral-300  rounded-full  md:top-[14%] right-[1%] top-[14%] fixed border border-black	sm:p-1 "
